...
/**
 * Адаптер для сервера AsgardDev High Five
 * Yii 2.2 / PHP 8.2
 */
final class AsgardDev_hf extends ServerAdapterBase
{
    /**
     * @inheritDoc
     */
    ...
    {
        // TODO реализовать под конкретную схему БД
        return ['dateEnd' => 0];
    }
    ...
    public function getItemsControl(array $itemsIds): array
    {
        ...
        $items = \app\models\AllItems::findAll(['item_id' => $itemsIds]);
        $names = [];
